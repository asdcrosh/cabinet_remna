...
export function AuthLayout({
  ...
  return (
    <div className="min-h-dvh bg-[#f4f5f1] dark:bg-[#0a0c0d] lg:grid lg:grid-cols-[minmax(22rem,0.72fr)_minmax(0,1.28fr)]">
      {enableTelegramMiniApp && <TelegramMiniAppAuth />}
      <aside className="relative hidden h-dvh overflow-hidden border-r border-white/[0.1] bg-[#0d1417] p-8 text-white lg:sticky lg:top-0 lg:flex lg:flex-col lg:justify-between xl:p-10">
        ...
        <div className="relative max-w-md">
          <div className="mb-5 h-1 w-12 bg-cyan-400" aria-hidden="true" />
      ...
      <main className="flex min-h-dvh items-start justify-center px-4 pb-[max(1.5rem,env(safe-area-inset-bottom))] pt-[max(1rem,env(safe-area-inset-top))] sm:px-8 sm:py-10 lg:items-center lg:px-10 xl:px-16">
        <div className="w-full max-w-[32rem]">
          ...
          <section className="border border-slate-300/80 border-t-2 border-t-cyan-500 bg-white p-5 dark:border-white/10 dark:border-t-cyan-300 dark:bg-white/[0.03] sm:p-7">
