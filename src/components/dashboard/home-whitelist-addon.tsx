...
export function HomeWhitelistAddon({
  ...
  if (active) {
    return (
      <section className="flex items-center gap-3 rounded-2xl border border-emerald-200 bg-emerald-50/70 px-4 py-3 dark:border-emerald-400/20 dark:bg-emerald-400/[0.06]">
