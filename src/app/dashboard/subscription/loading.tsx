export default function SubscriptionLoading() {
  return (
    <div className="page-stack">
      <section className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-surface-900 sm:p-5">
      ...
      <section className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm dark:border-white/10 dark:bg-surface-900">
        <div className="grid gap-0 sm:grid-cols-[minmax(0,1fr)_14rem] lg:grid-cols-[minmax(0,1fr)_18rem]">
          ...
          <aside className="hidden border-l border-slate-100 bg-slate-50/70 p-4 dark:border-white/10 dark:bg-white/[0.025] sm:block">
            <div className="skeleton mx-auto aspect-square max-w-[180px] rounded-lg" />
            <div className="skeleton mx-auto mt-3 h-6 w-28 rounded-lg" />
          </aside>
        </div>
      </section>
    </div>
