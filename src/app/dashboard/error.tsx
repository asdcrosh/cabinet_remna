...
export default function DashboardError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="card mx-auto max-w-xl px-4 py-10 text-center sm:py-12">
      ...
      <button type="button" className="btn-primary mt-6 w-full sm:w-auto" onClick={reset}>Повторить</button>
    </div>
  )
}
