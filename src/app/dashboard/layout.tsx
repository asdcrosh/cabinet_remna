...
export default async function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <NavBadgesProvider initialBadges={navBadges} supportEnabled={features.support}>
      ...
      <div className="dashboard-shell min-h-screen pt-[var(--tg-content-safe-area-inset-top,0px)] lg:pt-0">
        <a
        ...
        <main className="min-w-0 w-full overflow-x-clip lg:ml-64 lg:w-auto">
          <div className="dashboard-topbar sticky top-[var(--tg-content-safe-area-inset-top,0px)] z-50 flex h-14 items-center justify-between border-b px-4 backdrop-blur lg:fixed lg:right-6 lg:top-4 lg:h-auto lg:w-auto lg:border-0 lg:bg-transparent lg:p-0 lg:backdrop-blur-none">
