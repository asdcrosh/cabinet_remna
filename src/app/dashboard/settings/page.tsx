...
function SettingsSection({
  ...
  return (
    <section
      className={cn(
        'overflow-hidden rounded-lg border border-slate-200/80 bg-white/90 shadow-sm shadow-slate-200/50 backdrop-blur dark:border-white/10 dark:bg-white/[0.035] dark:shadow-black/20',
        className
      )}
    >
      <div className="border-b border-slate-100 bg-slate-50/55 px-4 py-4 dark:border-white/10 dark:bg-white/[0.02] sm:px-5">
        <div className="flex items-center gap-3">
          <div className="grid h-10 w-10 shrink-0 place-items-center rounded-lg bg-slate-950 text-cyan-200 shadow-sm dark:bg-cyan-300/10 dark:text-cyan-200">
            {icon}
          </div>
...
function LinkTile({
  ...
  return (
    <Link
      href={href}
      className="group flex min-h-24 items-center justify-between gap-4 rounded-lg border border-slate-200/80 bg-white/90 p-4 shadow-sm shadow-slate-200/50 transition hover:-translate-y-0.5 hover:border-cyan-200 hover:bg-cyan-50/50 hover:shadow-md dark:border-white/10 dark:bg-white/[0.035] dark:shadow-black/20 dark:hover:border-cyan-500/30 dark:hover:bg-cyan-500/10"
    >
...
function StatusPanel({
  ...
  return (
    <div className="rounded-lg border border-slate-200/80 bg-white/90 p-4 shadow-sm shadow-slate-200/50 dark:border-white/10 dark:bg-white/[0.035] dark:shadow-black/20">
      <div className="flex items-center gap-3">
...
function StatusLine({ label, value, active }: { label: string; value: string; active: boolean }) {
  return (
    <div className="flex items-center justify-between gap-3 rounded-lg border border-slate-200/80 bg-slate-50/80 px-3 py-2 text-sm dark:border-white/10 dark:bg-surface-950/35">
