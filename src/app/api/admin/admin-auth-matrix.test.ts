...
const routeCases: AdminRouteCase[] = [
  ...
  { name: 'referral settings read', module: './referrals/settings/route', method: 'GET' },
  { name: 'referral settings update', module: './referrals/settings/route', method: 'PATCH' },
  ...
  { name: 'node provisioning list', module: './nodes/provisioning/route', method: 'GET' },
