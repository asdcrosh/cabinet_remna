  ...
  return (
    ...
    >
        ...
        <LegalSection title="3. Тарифы, оплата и выдача доступа">
          ...
          <p>
            Автопродление включается только отдельным действием пользователя. Для него платёжный провайдер
            сохраняет идентификатор способа оплаты; полный номер карты и CVC/CVV кабинету не передаются.
            Дата следующего списания и состояние повторных попыток доступны в разделе платежей. Пользователь
            может отключить автопродление до следующего списания.
          </p>
        </LegalSection>
