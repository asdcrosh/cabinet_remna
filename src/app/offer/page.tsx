  ...
  return (
    ...
    >
      ...
      <LegalSection title="4. Стоимость и оплата">
        ...
        <p>
          Пользователь может отдельно включить автопродление в личном кабинете. В этом случае
          платёжный провайдер сохраняет способ оплаты и выполняет повторное списание по цене выбранного
          тарифа до окончания текущего доступа. Кабинет показывает дату следующей попытки. Автопродление
          можно отключить до списания; после трёх неуспешных попыток оно приостанавливается.
        </p>
      </LegalSection>
