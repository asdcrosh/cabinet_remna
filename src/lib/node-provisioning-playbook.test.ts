...
describe('node provisioning playbook safety', () => {
  ...
  it('issues certificates through the HTTP fallback without unsafe deployment', () => {
    ...
    expect(preparePair).toContain('pending_certificate_key_fingerprint=')
    expect(preparePair).toContain('pending_private_key_fingerprint=')
    expect(preparePair).toContain('[[ "$pending_certificate_key_fingerprint" != "$pending_private_key_fingerprint" ]]')
    ...
    expect(installPair).toContain('live_certificate_key_fingerprint=')
    expect(installPair).toContain('live_private_key_fingerprint=')
    expect(installPair).toContain('[[ "$live_certificate_key_fingerprint" != "$live_private_key_fingerprint" ]]')
